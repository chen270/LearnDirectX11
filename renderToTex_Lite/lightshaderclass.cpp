...
bool LightShaderClass::InitializeShader(ID3D11Device* device, HWND hwnd, WCHAR* vsFilename, WCHAR* psFilename)
{
	...
	result = D3DCompileFromFile(vsFilename, nullptr, D3D_COMPILE_STANDARD_FILE_INCLUDE, "LightVertexShader", "vs_5_0", D3DCOMPILER_STRIP_DEBUG_INFO, 0, &vertexShaderBuffer, &errorMessage);
	...
	result = D3DCompileFromFile(psFilename, nullptr, D3D_COMPILE_STANDARD_FILE_INCLUDE,
		"LightPixelShader", "ps_5_0", D3DCOMPILER_STRIP_DEBUG_INFO, 0, &pixelShaderBuffer, &errorMessage);
